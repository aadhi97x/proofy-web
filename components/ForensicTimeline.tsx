  ...
  if (timestamps.length === 0) {
    return (
      <div className="py-20 flex flex-col items-center justify-center glass border border-dashed border-white/5 rounded-[3rem] opacity-20">
        ...
        <span className="text-[10px] font-black uppercase tracking-[0.5em]">No_Sequential_Anomalies_Indexed</span>
      </div>
    );
  }
    ...
    <div className="space-y-16">
      ...
      <div className="flex flex-wrap gap-12 pt-10 px-8">
        ...
        <div className="flex items-center gap-4 group">
          ...
          <div className="space-y-0.5">
            <span className="text-[11px] font-black uppercase tracking-[0.4em] text-white/80 group-hover:text-purple-400 transition-colors">Neural Signature</span>
