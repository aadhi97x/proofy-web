...
const forensicModules = [
  {
    ...
    desc: "Breaks visuals down to raw pixel structure to detect manipulation at its origin. Forensic-grade scrutiny for digital fabrications.",
    tag: "Visual",
    code: "PX FORENSIC",
    icon: Fingerprint,
    color: "text-neon"
  ...
  },
  {
    ...
    desc: "Interrogates the raw audio spectrum to uncover artifacts left by neural voice synthesis and clones.",
    tag: "Audio",
    code: "VOICE SIG",
    icon: Waves,
    color: "text-danger"
  },
  {
    ...
    desc: "Delivers an auditable record of every analysis performed. Designed for formal evidence environments.",
    tag: "Documentation",
    code: "LAW CERT",
    icon: FileCheck,
    color: "text-white"
      ...
      <header className="flex flex-col md:flex-row items-end justify-between gap-10">
        <div className="space-y-6">
          <div className="flex items-center gap-4 text-white/20">
            <Terminal size={16} />
            <span className="text-[11px] font-black uppercase tracking-[0.5em]">Protocol_Library</span>
          </div>
          <div className="space-y-2">
            ...
            <p className="text-white/30 text-lg italic font-light tracking-tight max-w-lg">
              A comprehensive catalogue of the neural and structural protocols governing our analysis core.
            </p>
          </div>
        </div>
        <div className="flex items-center gap-6 py-6 px-10 glass border border-white/5 rounded-[2.5rem] bg-surface/20">
          <div className="flex flex-col text-right">
            <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em] mb-1">Standard_ISO</span>
            <span className="text-neon font-mono text-sm font-black italic tracking-tighter uppercase leading-none">v4.0.2_SECURE</span>
          </div>
        ...
        {forensicModules.map((sig, idx) => (
          ...
          >
            ...
            <div className="mt-12 pt-10 border-t border-white/5 flex items-center justify-between relative z-10">
              ...
              <span className="text-[10px] font-black text-white/10 uppercase tracking-widest group-hover:text-neon/40 transition-colors">Forensic_Grade</span>
            </div>
