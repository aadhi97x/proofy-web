    ...
    >
      ...
      >
        ...
        <div className="space-y-6 relative z-10">
          ...
          <h2 className="text-5xl md:text-6xl font-black italic uppercase tracking-tighter text-white">Forensic Intake</h2>
          <p className="text-white/40 text-xl max-w-md mx-auto leading-relaxed italic font-light">
            Securely transmit suspected neural fabrications for deep-layer interrogation.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-8 relative z-10">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center gap-8 text-[9px] font-bold text-white/10 uppercase tracking-[0.6em]">
              <span>Neural Handshake Protocol</span>
