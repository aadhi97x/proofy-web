  ...
  const handleCapture = async () => {
    ...
    if (context) {
      ...
      if (blob) {
        ...
        setStatus("INTERROGATING_LAYERS...");
        try {
    ...
    <div className="min-h-[calc(100vh-10rem)] flex flex-col items-center justify-center p-6 relative">
      ...
      <div className="relative w-full max-w-5xl aspect-video rounded-[4rem] overflow-hidden border border-white/10 shadow-[0_50px_100px_rgba(0,0,0,0.8)] bg-black group">
        ...
        <div className="absolute inset-0 pointer-events-none p-12">
            ...
            {!isCapturing && (
              ...
              >
                ...
                <div className="absolute right-0 bottom-1/4 text-right space-y-10 group-hover:-translate-x-2 transition-transform duration-700">
                  <div className="space-y-1">
                    <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em] block">Neural_Bandwidth</span>
          ...
          {/* Processing Overlay */}
          {isCapturing && (
            <div className="absolute inset-0 flex items-center justify-center pointer-events-auto bg-black/60 backdrop-blur-3xl animate-in fade-in duration-700">
      ...
      <div className="mt-16 text-center space-y-4 max-w-lg">
        ...
        <div className="space-y-2">
          <p className="text-white/40 text-lg font-light italic tracking-tight italic leading-relaxed">Ensure the biometric subject is centered within the lens array for precision artifact extraction.</p>
