...
const ResultsPreview: React.FC = () => {
  return (
    <section className="py-40 relative overflow-visible">
      ...
      <div className="relative glass border border-white/10 rounded-[5rem] p-16 md:p-32 flex flex-col items-center text-center gap-20 shadow-3xl bg-[#080808]/60 backdrop-blur-3xl overflow-hidden group">
        {/* Decorative Grid */}
        ...
        <div className="max-w-4xl space-y-12 relative z-10">
          <div className="space-y-8">
            <div className="flex items-center justify-center gap-6 text-neon/40">
              <Activity size={16} />
              <span className="text-[11px] font-black uppercase tracking-[0.8em]">Forensic Benchmarks</span>
              <Activity size={16} />
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-2xl text-white/30 font-light italic leading-relaxed max-w-3xl mx-auto">
                Every interrogation yields a granular decomposition of signals. We provide the forensic evidence so you can trust the conclusion. Our protocols are 100% explainable.
              </p>
            </div>
          </div>
        ...
        <div className="mt-20 flex flex-col items-center gap-6 relative z-10 opacity-40 hover:opacity-100 transition-opacity">
          <div className="flex items-center gap-4 text-white/20">
            <Target size={16} />
            <span className="text-[10px] font-black uppercase tracking-[0.5em]">Forensic Grade Infrastructure</span>
          </div>
