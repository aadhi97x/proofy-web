...
const faqs = [
  {
    ...
    a: "Our neural core maintains a 98.4% success floor across benchmark clusters including FaceForensics++. However, we always provide calibrated confidence metrics because digital interrogation is probabilistic, not absolute."
  },
  {
