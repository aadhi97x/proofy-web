...
const JudicialReport: React.FC<{ result: AnalysisResult; onBack: () => void }> = ({ result, onBack }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-12 pb-32">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-6xl font-black tracking-tighter uppercase italic leading-[0.8] flex flex-col">
              <span className="text-white">Full Forensic</span>
              <span className="text-neon">Intelligence Log</span>
            </h2>
            <div className="flex items-center gap-4">
              ...
              <p className="text-white/20 text-sm italic font-light tracking-tight max-w-sm">
                Authenticated proof of neural fabrication or organic origin.
              </p>
            </div>
          </div>
        </div>
      ...
      {isLoading ? (
        <div className="py-60 glass border border-white/10 rounded-[4rem] flex flex-col items-center justify-center">
          <NeuralLoader label="Interrogating Archive Seeds" />
        </div>
      ) : (
        <motion.div
            ...
            <div className="relative z-10">
              <div className="mb-16 pb-16 border-b border-white/5 flex flex-col md:flex-row justify-between items-start gap-10 print:border-black/10">
                <div className="space-y-4">
                  <span className="px-6 py-2 bg-neon/10 border border-neon/20 rounded-full text-neon text-[10px] font-black uppercase tracking-[0.4em]">Official_Forensic_Export</span>
              ...
              <div className="mt-24 pt-16 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-10 opacity-30 print:border-black/10 print:text-black">
                ...
                <span className="text-[9px] font-mono font-bold uppercase tracking-widest">PROOFY FORENSIC ENGINE V2.0.4</span>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <footer className="pt-20 text-center space-y-6">
        ...
        <p className="text-white/10 text-[9px] font-mono uppercase tracking-[0.8em]">Neural Extraction Protocol Fully Terminated</p>
      </footer>
    </div>
  );
};
