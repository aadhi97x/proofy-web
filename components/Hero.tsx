...
const Hero: React.FC = () => {
  ...
  return (
    <div className="text-center space-y-16 max-w-5xl mx-auto relative min-h-screen flex flex-col justify-center items-center pt-0">
      ...
      <div className="space-y-10 pointer-events-none -mt-32">
        ...
        <div className="space-y-10 max-w-4xl mx-auto">
          <motion.p
            ...
            className="text-2xl md:text-4xl text-white/90 font-light tracking-tight italic leading-relaxed drop-shadow-md"
          >
      ...
      <motion.div
        ...
        className="flex flex-col items-center gap-10 relative z-20 pointer-events-auto"
      >
        <button
