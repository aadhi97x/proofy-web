...
const categories = [
  {
    id: 'visual',
    title: "Optical Neural Inspection",
  ...
  },
  {
    ...
    detail: "Frame-by-frame interrogation ensuring that motion vectors and environmental reflections remain logically consistent across time. Detecting frame-swapping, GAN-stitching, and pixel-level motion smear.",
      ...
      <div className="flex flex-col lg:flex-row gap-20 items-start">
        <div className="lg:w-1/3 space-y-8 sticky top-32">
          ...
          <p className="text-white/40 text-lg leading-relaxed italic font-light max-w-sm">
            Our neural forensic suite operates across three primary vectors, interrogating the very fabric of digital media to verify authenticity.
          </p>
