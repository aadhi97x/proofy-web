        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {signals.map((sig, i) => (
            <motion.div
              ...
              className={`flex flex-col items-center text-center lg:items-start lg:text-left p-10 glass border border-white/5 rounded-[2.5rem] group cursor-default transition-all duration-700 hover:border-white/20 bg-surface/20 hover:bg-surface/40 shadow-2xl relative overflow-hidden`}
            >
