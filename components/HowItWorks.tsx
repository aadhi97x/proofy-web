...
const steps = [
  ...
  {
    id: 2,
    title: "NEURAL_INTERROGATION",
    short: "Spectral Domain & Artifact Scan.",
    full: "Our neural core probes the pixel/audio structure for frequency domain anomalies and generative patterns characteristic of deepfake fabrication models.",
    icon: Search,
    color: "text-cyber"
  },
  {
      ...
      <div className="space-y-8 text-center relative z-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-white/20 text-xl max-w-2xl mx-auto italic font-light leading-relaxed">
            An automated sequence of forensic protocols designed to isolate and expose neural fabrications.
          </p>
        </div>
      </div>
