...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onNavigate, onReset, expanded, onToggle, privacyMode, setPrivacyMode }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 h-screen glass border-r border-white/5 flex flex-col p-12 transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] z-[70] ${expanded ? 'w-[360px] translate-x-0' : 'w-[360px] -translate-x-full'
          }`}
      >
        <div className="mb-20">
          ...
          <div className="flex items-center gap-2 mt-4 ml-1">
            ...
            <p className="text-[10px] font-bold text-white/30 uppercase tracking-[0.4em]">Node Active: Forensic-v2</p>
          </div>
        </div>
